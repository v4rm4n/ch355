...
class Match(Base):
    ...
    white_player_id: Mapped[int | None] = mapped_column(ForeignKey("users.id"), nullable=True)
    black_player_id: Mapped[int | None] = mapped_column(ForeignKey("users.id"), nullable=True) 
